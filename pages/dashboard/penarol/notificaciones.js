...
import {db, PATH_api_send_notification} from '../../../components/penarol/config';
                        ...
                        <div className="input-single-container" style={{backgroundColor: 'yellow', padding: 10, marginTop: 20}}>
                            ...
                            <>
                                <ul style={{margin: 20}}>
                                    ...
                                    {sendedNotifications.errorChunk ? <li>Error chunk: {sendedNotifications.errorChunk} (Error al enviar 100 notificaciones)</li> : null}
                                </ul>
